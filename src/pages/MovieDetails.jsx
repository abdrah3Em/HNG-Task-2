    ...
    <div className="lg:flex w-full">
      ...
      <div className="lg:flex-1 lg:w-full w-[90%] mx-auto">
        ...
        {!isLoading && !error && details && (
          <div className="md:w-[90%] w-full mx-auto lg:my-6 card-content">
            <div
            ...
            <div className="my-4">
              <div className="flex xl:flex-row flex-col justify-between">
                <div className="flex flex-wrap gap-x-2 items-center">
                  ...
                  {details?.genres.map((genr, index) => (
                    <p
                      key={index}
                      className="border border-red-100 rounded-full py-0.5 lg:px-4 px-2 mx-1 text-red-600 font-medium xl:mt-0 my-1.5"
                    >
                      {genr.name}
                    </p>
                  ))}
                </div>
                <div className="flex items-center xl:my-0 card-content">
              ...
              <div className="my-6 flex lg:flex-row flex-col justify-center">
                <div className="flex-1 md:mr-6 ">
                  ...
                  <div className="grid gap-y-6 my-9">
                    ...
                    <div className="flex w-full">
                      <button className="bg-[#BE123C] md:w-fit w-full xl:px-6 lg:px-4 px-3 py-2.5 card-content rounded-[10px] text-white flex justify-center">
                        Top rated movie #65
                      </button>
                      <select
                        name=""
                ...
                <div className="lg:w-60 w-full">
                  <div className="">
                    <button className="bg-[#BE123C] w-full py-2 lg:card-content my-4 rounded-[10px] text-white flex justify-center gap-x-3">
                      <img src={TwoTickets} alt="tickets" />
                      See Showtimes
                    </button>
                    <button className="bg-red-100 border border-[#BE123C] w-full py-2 card-content rounded-[10px] flex justify-center gap-x-3">
