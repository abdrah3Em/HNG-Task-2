...
const Home = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="spacer flex justify-between w-11/12 mx-auto xl:px-8 px-4">
      ...
      <footer className="spacer  mx-auto w-[300px] flex flex-col justify-center items-center">
