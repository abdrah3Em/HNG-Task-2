  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col text-white xl:px-16 px-8 py-3">
        <header className="md:my-6 card-content flex items-center justify-between slideshow top-0 z-50">
          <div>
        ...
        {currentMovie && (
          <div className="text-center flex flex-col justify-center md:items-start items-center lg:w-[600px] md:w-[75%] w-[100%] lg:mt-20 mt-0 md:mx-0 mx-auto">
            <h1 className="md:text-5xl text-2xl font-bold md:text-start text-center card-content">
              {currentMovie.title}
            </h1>
            <div className="flex justify-between card-content gap-x-8">
